...
const paths: Record<IconName, React.ReactNode> = {
  ...
  'brand-apple': (
    <Path d="M8.286 7.008c-3.216 0 -4.286 3.23 -4.286 5.92c0 3.229 2.143 8.072 4.286 8.072c1.165 0 2.429 -.876 3.714 -.876c1.286 0 2.143 .876 3.714 .876c2.857 0 4.286 -5.263 4.286 -5.263c-1.639 -.814 -2.714 -2.33 -2.714 -4.415c0 -1.975 1.07 -3.214 2.143 -4.322c-1.429 -1.643 -2.857 -2 -4.286 -2c-1.429 0 -2.571 .876 -3.714 .876s-1.714 -.876 -3.143 -.876z" />
  ),
  eye: (
    <>
